...
public class SqlHelper extends SQLiteOpenHelper implements SettingsConstants {
	...
	// @formatter:off
	"CREATE TABLE " + SETTINGS_TABLE + " (" + NUMBER_PLAYER_COL + " INTEGER NOT NULL, " + ZOOM_COL + " INTEGER NOT NULL," + INPUT_COL + " VARCHAR(80),"
			+ NAME_COL + " VARCHAR(80)," + BACKGROUND_COL + " INTEGER NOT NULL," + ALT_PIXELFORMAT + " INTEGER NOT NULL," + SPEED_COL + " INTEGER NOT NULL );";
