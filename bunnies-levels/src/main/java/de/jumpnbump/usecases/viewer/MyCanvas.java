...
public class MyCanvas extends JPanel {
	...
	private void paintWaters(Graphics g) {
		for (Water w : this.objectContainer.getAllWaters()) {
	...
	private void paintJumpers(Graphics g) {
		for (Jumper w : this.objectContainer.getAllJumper()) {
	...
	private void paintIceWalls(Graphics g) {
		for (IcyWall w : this.objectContainer.getAllIcyWalls()) {
	...
	private void paintWalls(Graphics g) {
		for (Wall w : this.objectContainer.getAllWalls()) {
